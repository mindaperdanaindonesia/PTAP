        ...
        <div class="leftmenu">     
         ...
         <div class="pondasiakun">
            ...
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown"><a href=""><span class="iconfa-reorder"></span> Account</a>
                	<ul>
                    	<li><a href="<?php echo base_url();?>setting/account">Create</a></li>
                    	<li><a href="<?php echo base_url();?>setting/account">List</a></li>
                    </ul>
                </li>
            </ul>
        </div><!--leftmenu-->
