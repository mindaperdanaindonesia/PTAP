        ...
        <div class="leftmenu">        
         ...
         <div class="pondasiakun">
            ...
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown"><a href=""><span class="iconfa-calendar"></span> Teacher Schedule</a>
                	<ul>
                    	<li><a href="<?php echo base_url();?>calendar/event">Create</a></li>
                    	<li><a href="<?php echo base_url();?>calendar/event">List</a></li>
                    </ul>
                </li>
				<li class="dropdown"><a href=""><span class="iconfa-calendar"></span> Student Schedule</a>
                	<ul>
                    	<li><a href="<?php echo base_url();?>calendar/event">Create</a></li>
                    	<li><a href="<?php echo base_url();?>calendar/event">List</a></li>
                    </ul>
                </li>
				<li class="dropdown"><a href=""><span class="iconfa-calendar"></span> School Event & Calendar</a>
                	<ul>
                    	<li><a href="<?php echo base_url();?>calendar/event">Create</a></li>
                    	<li><a href="<?php echo base_url();?>calendar/event">List</a></li>
                    </ul>
