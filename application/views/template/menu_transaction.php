        ...
        <div class="leftmenu">     
         ...
         <div class="pondasiakun">
            ...
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown"><a href=""><span class="iconfa-check"></span> Contract</a>
                	<ul>
                    	<li><a href="<?php echo base_url();?>transaction/contract/add">Create</a></li>
                    	<li><a href="<?php echo base_url();?>transaction/contract">List</a></li>
                    </ul>
                </li>
            </ul>
        </div><!--leftmenu-->
