...
<div class="maincontentinner">
                <div class="row-fluid">
					...
					<a data-toggle="modal" href="#myModal" class="btn btn-success" style="margin-bottom:10px;color:white" id="add"><i class="icon-plus icon-white"></i> &nbsp;Add New City</a>
				...
				<tbody id="trow">
					...
					<tr style="font-size:9pt">
						...
						<td>
						<a data-toggle="modal" href="#myModal" class="btn btn-primary btns" onclick="edit('<?php echo $row->id;?>')" style="color:white"><i class="icon-edit icon-white"></i></a>
						<button type="button" class="btn btn-danger btns" onclick="removes('<?php echo $row->id;?>')" style="color:white"><i class="icon-remove icon-white"></i></button>
						</td>
					</tr>
					<?php $no++; } ?>
				</tbody>
