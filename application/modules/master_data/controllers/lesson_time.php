...
class Lesson_time extends MX_Controller {
	...
	public function index(){
		...
		$data['head']   = 'Lesson Time';
		$data['icon']	= '<span class="iconfa-time"></span>';
	...
	function get_class($code){
		$a = $this->db->query("select * from class_master where org_id = '$code'")->result();
		$data = '';
		foreach($a as $row){
