...
function city($code){
	$CI 	=& get_instance();
	return $CI->db->query("select city_name from city where city_code = '$code' ")->row()->city_name;
}

function region($code){
	$CI 	=& get_instance();
	return $CI->db->query("select region_name from region where region_code = '$code' ")->row()->region_name;
}

function country($code){
	$CI 	=& get_instance();
	return $CI->db->query("select country_name from country where country_code = '$code' ")->row()->country_name;
}
